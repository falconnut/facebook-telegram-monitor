...
โปรเจกต์นี้ตรวจโพสต์ใหม่จากเพจ **Golfclub by benz** ทุก 30 นาที แล้วส่งโพสต์ใหม่เข้า Telegram ผ่านบอทของคุณ โดยไม่ต้องเปิด Mac ค้างไว้
...
หลังจากนั้นระบบจะตรวจทุก 30 นาที เมื่อพบโพสต์ใหม่จึงส่ง Telegram
